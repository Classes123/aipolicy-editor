...
internal class O_USE_SKILL_2
{
	...
	{
		return string.Format("{0}", "O_USE_SKILL_2");
	}

	public static O_USE_SKILL_2 Read(BinaryReader br)
	{
		return new O_USE_SKILL_2
		{
			uSkill = br.ReadInt32(),
	...
	public static void Write(BinaryWriter bw, O_USE_SKILL_2 param)
	{
